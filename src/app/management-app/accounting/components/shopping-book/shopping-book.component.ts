...
@Component({
  ...
  styleUrls: ['./shopping-book.component.scss']
})
export class ShoppingBookComponent implements OnInit {
  public accountingId = AccountingEnum.SHOPPINGBOOK;
